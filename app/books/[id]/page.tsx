          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                >
                  {[...Array(Math.min(book.stockCount, 10))].map((_, i) => (
              ...
              {book.inStock && <span className="text-sm text-muted-foreground">{book.stockCount} in stock</span>}
            </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{new Date(book.publishedDate).toLocaleDateString()}</p>
                </div>
                <div>
